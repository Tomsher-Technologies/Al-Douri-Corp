@extends('layouts.admin.app', ['body_class' => 'nav-md', 'title' => 'Create Division'])
@section('content')
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.divisions.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group position-relative error-l-50">
                                ...
                                <textarea class="form-control" id="engEditor2" name="content_2" rows="2">{{ old('content_2') }}</textarea>
                                <x-input-error name='content_2' />
                            </div>
                            <div class="form-group position-relative error-l-50">
                                <label>Arabic Content 2</label>
                                <textarea class="form-control" id="arEditor2" dir="rtl" name="ar_content_2" rows="2">{{ old('ar_content_2') }}</textarea>
