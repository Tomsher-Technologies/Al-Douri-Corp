    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form class="repeater" method="POST" action="{{ route('admin.branch.update', $branch) }}" >
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="ar_name" dir="rtl" class="form-control"
                                    value="{{ old('ar_name', $branch->ar_name) }}" >
                            ...
                            <div data-repeater-list="locations">
                                ...
                                <div data-repeater-item class="mt-3 px-sm-40 px-20 row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="exampleInputEmail1">Arabic Name</label>
                                        <input type="text" class="form-control" value="{{ old('ar_location') }}" name="ar_location" placeholder="Enter arabic name" >
                                    </div>
                                    <div class="form-group col-md-6">
