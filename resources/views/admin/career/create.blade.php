@extends('layouts.admin.app', ['body_class' => 'nav-md', 'title' => 'Create Job'])
@section('content')
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.careers.store') }}" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-group position-relative error-l-50">
                                ...
                                <textarea class="form-control" id="arEditor" dir="rtl" name="ar_description" rows="2">{{ old('ar_description') }}</textarea>
