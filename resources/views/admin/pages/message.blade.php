@extends('layouts.admin.app', ['body_class' => 'nav-md', 'title' => 'Chairmans Message'])
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <h1>Chairmans Message</h1>
        ...
        <div class="row">
            <div class="col-8 offset-2">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <form method="POST"
                            action="{{ route('admin.page.store-message', [
                                'page_name' => 'message',
                            ]) }}"
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Image <span class="text-info">(Please upload an image with size less than 500 KB and dimensions 1694x1967 pixels)</span></label>
                                <div class="input-group mb-3">
                                    <div class="custom-file">
