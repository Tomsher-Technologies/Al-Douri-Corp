                    ...
                    <div class="card-body">
                        <form method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="info_heading" class="form-control"
                                    value="{{ old('info_heading', $data->getTranslation('heading2','en')) }}" >
                                <x-input-error name='info_heading' />
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Arabic Info Heading</label>
                                <input type="text" name="ar_info_heading" dir="rtl" class="form-control"
                                    value="{{ old('ar_info_heading', $data->getTranslation('heading2', 'ar')) }}" >
                                <x-input-error name='ar_info_heading' />
                            </div>
