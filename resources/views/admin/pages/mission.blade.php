                        ...
                        <form method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="vision_heading" class="form-control"
                                    value="{{ old('vision_heading', $data->getTranslation('heading2','en')) }}" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="ar_vision_heading" dir="rtl" class="form-control"
                                    value="{{ old('ar_vision_heading', $data->getTranslation('heading2', 'ar')) }}" >
                                <x-input-error name='ar_vision_heading' />
                            </div>

                            <div class="form-group position-relative error-l-50">
                                <label>Vision Content</label>
                                <textarea class="form-control" id="engContent1" name="vision_content" rows="2">{{ old('vision_content', $data->getTranslation('content2','en')) }}</textarea>
                                <x-input-error name='vision_content' />
                            </div>
                            <div class="form-group position-relative error-l-50">
                                <label>Arabic Vision Content</label>
                                <textarea class="form-control" id="arContent1" dir="rtl" name="ar_vision_content" rows="2">{{  old('ar_vision_content', $data->getTranslation('content2', 'ar')) }}</textarea>
